...
- (void)viewDidLoad {
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRect:CGRectMake(0, 0, DEVICE_WIDTH, DEVICE_HEIGHT)];
    
    [maskPath appendPath:[[UIBezierPath bezierPathWithRoundedRect:CGRectMake(50, 50+ 64,DEVICE_WIDTH - 100, DEVICE_WIDTH - 100) cornerRadius:1] bezierPathByReversingPath]];
    ...
    imageView = [[UIImageView alloc]initWithFrame:CGRectMake(50, 50+ 64,DEVICE_WIDTH - 100, DEVICE_WIDTH - 100)];
    imageView.image = [UIImage imageNamed:@"contact_scanframe"];
    [self.view addSubview:imageView];
    
    
//    UILabel * introudctionLB= [[UILabel alloc] initWithFrame:CGRectMake(50, imageView.bottom + 20, widthScreen - 100, 30)];
...
//
//    self.flashlightBtn = [[UIButton alloc]initWithFrame:CGRectMake(widthScreen/2 - 20, introudctionLB.bottom + 20, 40, 40)];
