...
#import "DDCQRCodeScanningView.h"
...
@interface DDCQRCodeScanningView ()
@property (nonatomic, strong) UIView *contentView;
@property (nonatomic, strong) NSTimer *timer;
@property (nonatomic, strong) UIImageView *scanningline;
@end

@implementation DDCQRCodeScanningView
...
- (void)initialization {
    ...
    _scanningImageName = @"DDCQRCode.bundle/QRCodeScanningLine";
}
